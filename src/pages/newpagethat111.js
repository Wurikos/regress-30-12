...
import { Theme, Link, Image, Box, Button, Hr, Icon, Input, Text, List } from "@quarkly/widgets";
import { Helmet } from "react-helmet";
import { GlobalQuarklyPageStyles } from "global-page-styles";
import { Formspree, GoogleMap, Menu, Section, SocialMedia, StackItem, Override, Stack } from "@quarkly/components";
import * as Components from "components";
import { MdFace } from "react-icons/md";
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"newpagethat111"} />
		<Helmet>
			<title>
				Quarkly export
			</title>
		...
		<Box width="500px" height="500px" background="#85d9e8">
			<Text font="--headline1" color="#873587">
				Some text
			</Text>
			<Text font="--headline1" color="#873587">
				Some text
